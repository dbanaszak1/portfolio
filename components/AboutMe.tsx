...
const AboutMe = () => {
  ...
  <motion.div ref={container} style={{scale: scrollYProgress, opacity: scrollYProgress}} className='w-5/6 m-auto relative pt-16 max-w-[940px] border-b-[1px] border-gray-300 pb-6'>
    ...
    <div className='font-alkatra text-4xl text-white relative z-20'>
    ...
    <span className='font-alkatra text-transparent text-4xl bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600'>Creative Student with open mind</span>
    <div className='text-gray-400 lg:w-2/3'>
      <p>
        I study Computer Science at Adam Mickiewicz University. I am actively
          ...
          very creative and skilled in designing. I enjoy teamwork and I hope I will
          fit any team perfectly
      </p>
    </div>
    <div className='flex my-4'>
      <button className='px-4 py-2 bg-gray-800 border-[1px] border-white text-white flex items-center rounded-full hover:bg-white hover:text-black duration-500'>
