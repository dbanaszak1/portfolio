    ...
    const projects = [
        {
            ...
            logoclass:"w-24 h-24 m-auto",
            text:[
                    "Responsively designed","Clean and nicely designed","Modern and innovative","Step by step made by me"
            ],
        ...
        },
        {
            name:"Portfolio",
            url:"https://dbanaszak1.github.io/vite-deploy/home",
            logo:"https://github.com/dbanaszak1/portfolio/blob/main/images/devb-high-resolution-logo-black-transparent.png?raw=true",
            logoclass:"w-32 h-20 m-auto lg:ml-4",
            screenshots:[],
            text:[
                "Responsively designed","Animated with motion","Hosted with GhPages","Step by step made by me"
            ],
            tech:[
